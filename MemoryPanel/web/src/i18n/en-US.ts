...
export const enUS = {
  ...
  'menu.evidence': 'Asset Receipts',
  'menu.review': 'Candidate Review',
  ...
  'menu.desc.evidence': 'Asset usage receipts · evidence chain',
  'menu.desc.review': 'Approve / reject candidate assets',
  ...
  // ===== Evidence (Task 4 asset usage receipt page) =====
  'evidence.title': 'Asset Usage Receipt',
  'evidence.subtitle': '{{count}} sessions with evidence — pick one on the left to view its receipt',
  'evidence.refresh': 'Refresh',
  'evidence.export': 'Export receipt',
  'evidence.export.noReceipt': 'No receipt to export yet — pick a session on the left to load it',
  'evidence.loading': 'Loading…',
  'evidence.retry': 'Retry',
  'evidence.sessions.title': 'Sessions',
  'evidence.sessions.empty': 'No sessions with evidence yet — receipts appear here after the model uses skill / memory tools and L0 is settled',
  'evidence.detail.empty': 'Select a session on the left to view its asset usage receipt',
  'evidence.load_sessions_error': 'Failed to load sessions',
  ...
  'evidence.eff.adopted': 'Adopted, pending verification',
  'evidence.eff.selected': 'Selected, pending adoption',
  'evidence.eff.reference_only': 'Reference only',
  'evidence.stage.recalled': 'Recalled',
  'evidence.stage.selected': 'Selected',
  'evidence.stage.injected': 'Injected',
  'evidence.stage.used': 'Used',
  'evidence.stage.validated': 'Validated',
  'evidence.stage.corrected': 'Corrected',
  'evidence.stage.contributed': 'Contributed',
  'evidence.type.product_knowledge': 'Product knowledge',
  'evidence.label.source': 'source',
  'evidence.label.stage': 'Stages',
  'evidence.label.risk': 'Risks',
  'evidence.label.evidence_decision': 'Evidence / Decision',
  'evidence.label.no_evidence': '(no evidence)',
  'evidence.label.turn': 'Turn {{n}}',
  'evidence.label.no_turn': '(no turn data)',
  'evidence.label.no_body': '(no body)',
  'evidence.label.expand': 'Expand',
  'evidence.label.collapse': 'Collapse',
  'evidence.label.view_all': 'View all',
  'evidence.risk.low_confidence': 'Low confidence',
  'evidence.risk.possibly_stale': 'Possibly stale',
  'evidence.risk.multi_source': 'Multiple sources',
  'evidence.scope.team': 'Team pool',
  'evidence.scope.self': 'Agent-owned',
  'evidence.group_count': '{{type}} ({{count}})',

  // ===== Review (Task 6 candidate asset review page) =====
  'review.title': 'Candidate Asset Review',
  'review.subtitle': '{{count}} candidates pending; approved ones enter the authoritative asset store',
  'review.refresh': 'Refresh',
  'review.loading': 'Loading…',
  'review.retry': 'Retry',
  'review.load_error': 'Failed to load candidates',
  'review.list.title': 'Candidates',
  'review.list.empty': 'No candidates yet — they appear here after task finalization (mem:finalize / mem:propose)',
  'review.detail.empty': 'Select a candidate on the left to review',
  'review.field.source': 'Source',
  'review.field.bucket': 'Bucket',
  'review.field.risk': 'Risk',
  'review.field.evidence': 'Evidence',
  'review.field.content': 'Content preview',
  'review.field.reject_reason': 'Reject reason',
  'review.no_content': '(no content, or not stored in metadata_json)',
  'review.reject': 'Reject',
  'review.approve': 'Approve',
  'review.reject_placeholder': 'Reject reason (optional, kept for audit)',
  'review.approved_with_skill': 'Approved and published to skill domain ({{id}})',
  'review.approved_reused': 'Approved; skill already exists ({{id}}), reused without re-creating',
  'review.approved_skipped': 'Approved; no content or non-skill type, skill domain not published',
  'review.rejected': 'Rejected (failed, kept for audit)',
