...
export const enUS = {
  ...
  'evidence.select_session': 'Select session',
  ...
  'evidence.no_data': 'No asset evidence yet — receipts appear here after the model uses skill / memory tools and L0 is settled',
  'evidence.load_sessions_error': 'Failed to load sessions',
  'evidence.load_receipt_error': 'Failed to load receipt',
  'evidence.chain_issues': '⚠️ Evidence chain integrity warnings',
